...
license, all contributions to the Node Clinic project are submitted _to_ the
...
Contribution Certification _is not the same as the standard DCO_ and we do not
...
`Signed-off-by` statement within each commit. The statement _must_ include
